...
ggsave(plot=plot_grid(plotlist=gglist, ncol=1, align='v'),
       filename=sprintf('%s/barplot_Order_rrarefy.pdf', dir$figdir), w=6, h=5)
...
ggsave(plot=gglist[[1]],
       filename=sprintf('%s/barplot_Order_rrarefy_pro_caption.pdf', dir$figdir), w=6, h=10)
       
ggsave(plot=gglist[[2]],
       filename=sprintf('%s/barplot_Order_rrarefy_fng_caption.pdf', dir$figdir), w=6, h=10)
